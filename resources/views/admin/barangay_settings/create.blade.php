...
<div class="p-6 bg-gray-50 min-h-screen">
    <h2 class="text-2xl font-bold mb-4 text-gray-800">Create Barangay Information</h2>

    <div class="bg-white p-6 rounded-lg shadow">
        <form action="{{ route('admin.barangay_settings.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
