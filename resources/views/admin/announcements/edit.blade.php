...
<div class="container mt-4">
    <div class="card-wrapper">
        <h1>Edit Announcement <span class="edit-badge">EDIT MODE</span></h1>

        <div class="changes-indicator" id="changesIndicator">
            <span class="save-icon">💾</span> You have unsaved changes
        </div>
        ...
        <form action="{{ route('admin.announcements.update', $announcement) }}" method="POST" id="announcementForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="titleInput" class="form-control" value="{{ $announcement->title }}" required pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed">
                <div class="error-message" id="titleError">Only letters and spaces are allowed in the title</div>
            </div>
            <div class="mb-3">
                <label class="form-label">Content</label>
                <div class="input-wrapper">
                    <textarea name="content" id="contentInput" class="form-control" rows="4" required>{{ $announcement->content }}</textarea>
...
<script>
    ...
    const originalTitle = document.getElementById('titleInput').value;
    const originalContent = document.getElementById('contentInput').value;
